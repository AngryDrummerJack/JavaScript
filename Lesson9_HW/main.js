...
// for (let arrElement of simpsons) {
//     let mainDiv = document.createElement(`div`);
//     mainDiv.classList.add(`member`);
//     let memberDiv = document.createElement(`div`);
//     memberDiv.innerHTML = `<h3>${arrElement.name}  ${arrElement.surname}</h3> <p>Вік:${arrElement.age}, Інформація:${arrElement.info}</p>`;
//     let memberImg = document.createElement(`img`);
//     memberImg.src = arrElement.photo;
//     mainDiv.append(memberDiv, memberImg);
...
//     mainDiv.classList.add(`borders`);
//
//     let duration = document.createElement(`div`);
//     mainDiv.append(duration);
//     duration.classList.add(`locate`);
//
...
// block.innerHTML = `<h2>Example text</h2>`;
...
// let newUl = document.getElementsByClassName(`menu`)[0];
...
//     newDiv.innerHTML = `<h2>${element.title}</h2> Duration: ${element.monthDuration}`;
...
// За допомоги скріпта для кожного елементу масиву зробити <div class='item'> ,  в якому буде <h1 class='heading'>  з title  елементу, та
